...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="{{ route('home') }}" class="logo d-flex align-items-center">
      ...
      <span class="d-none d-lg-block">Permata</span>
    </a>
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          <li class="dropdown-header">
            <h6>{{ (Auth::user() != null && Auth::user()->is_admin == 1)? Auth::user()->name : Auth::guard('pasien')->user()->name }}</h6>
            <span class="small">{{ (Auth::user() != null && Auth::user()->is_admin == 1)? Auth::user()->email : Auth::guard('pasien')->user()->email }}</span>
          </li>
          <li>
            <hr class="dropdown-divider">
          </li>
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center" href="{{ (Auth::user() != null && Auth::user()->is_admin == 1)? route('admin.profile') : route('profile') }}">
